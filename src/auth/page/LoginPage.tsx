import { Container, GridItem, Grid, VStack, Heading, Input, FormLabel, FormControl, Button, 
    InputGroup, InputRightElement, FormErrorMessage } from "@chakra-ui/react"
...
export const LoginPage = () => {
    ...
    const { isPasswordValid, isUserNameValid, onChange, onLoginClick, formErrors} = useLogin();
    ...
    return (
        <Container  w='96vw' maxW='99vw' height='95vh' maxH='95vh' my={5} >
            <Grid
                ...
                alignItems='center'
            >
                <GridItem placeSelf='center' w='36vw' h='fit-content'   bgColor='#fff'borderRadius='30' shadow='dark'>
